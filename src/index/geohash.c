...
void
get_geohash_range (geohash_range_t *long_range, geohash_range_t *lat_range)
{
...
geohash_bits_t *
geohash_encode (const geohash_range_t *long_range,
                const geohash_range_t *lat_range, double longitude,
...
geohash_area_t *
geohash_decode (const geohash_range_t long_range,
                const geohash_range_t lat_range, const geohash_bits_t hash)
{
  return NULL;
}

geohash_area_t *
geohash_decode_type (const geohash_range_t long_range,
...
geohash_area_t *
geohash_decode_WGS84 (const geohash_range_t long_range,
                      const geohash_range_t lat_range,
                      const geohash_bits_t hash)
{
  return NULL;
...
bool
geohash_decode_area_longlat (const geohash_area_t *area, double *xy)
{
  return false;
}

bool
geohash_decode_longlat_type (const geohash_area_t *area, double *xy)
{
  return false;
}

bool
geohash_decode_longlat_WGS84 (const geohash_area_t *area, double *xy)
{
  return false;
}

geohash_neighbors_t *
geohash_query_neighbors (const geohash_bits_t *hash)
{
  return NULL;
}
