...
se_geom *
geom_read (const char *data, int len, int flag)
{
...
se_geom *
geom_read_ora (int i_n, const int *i_p, int c_n, int c_dim, const double *c_p,
               int flag)
{
}

void
geome_write (const se_geom *geom, char **data, int *len, int flag)
{
}

void
geom_write_ora (const se_geom *geom, int *i_n, int **i_p, int *c_n,
                double **c_p)
{
}

void
geom_free (se_geom *geom)
{
}
