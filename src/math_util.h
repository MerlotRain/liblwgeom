...
void math_circle_center_radius (double x1, double y1, double x2, double y2,
                                double x3, double y3, double *radius,
                                double *cw, double *cy);

double math_circle_length (double x1, double y1, double x2, double y2,
                           double x3, double y3);

double math_bezier_length (double x1, double y1, double x2, double y2,
